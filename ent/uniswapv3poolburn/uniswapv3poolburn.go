...
const (
	// Label holds the string label denoting the uniswapv3poolburn type in the database.
	Label = "uniswap_v3pool_burn"
	...
	EdgeEvent = "event"
	// Table holds the table name of the uniswapv3poolburn in the database.
	Table = "uniswap_v3pool_burns"
	// EventTable is the table that holds the event relation/edge.
	EventTable = "uniswap_v3pool_burns"
...
// Columns holds all SQL columns for uniswapv3poolburn fields.
var Columns = []string{
	FieldID,
	FieldOwner,
	FieldTickLower,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "uniswap_v3pool_burns"
